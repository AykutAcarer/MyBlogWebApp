        ...
        <div class="container">
            <div class="row new-account-login">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <form class="mt-3 review-form-box" id="formRegister" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="firstname" class="form-control" id="InputName" placeholder="First Name"> </div>
                            <div class="form-group col-md-6">
                                <label for="lastname" class="mb-0">Last Name</label>
                                <input type="text" name="lastname" class="form-control" id="InputLastname" placeholder="Last Name"> </div>
                            <div class="form-group col-md-6">
                    ...
                    <p class="message">Already registered? <a href="<?=ROOT?>login">Login</a></p>
                </div>
            </div>
            <!-- <div class="row">
                <div class="col-sm-6 col-lg-6 mb-3">
