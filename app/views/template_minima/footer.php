...
<footer>
    ...
    <script type="text/javascript" src="<?=ASSETS?>template_minima/js/responsee.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>template_minima/js/jquery.events.touch.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>template_minima/owl-carousel/owl.carousel.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>template_minima/js/template-scripts.js"></script> 
  </body>
</html>